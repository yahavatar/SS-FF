function skipscreen_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
skipscreen_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				skipscreen_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
skipscreen_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
skipscreen_xmlhttpRequester.prototype.setupRequestEvent =
